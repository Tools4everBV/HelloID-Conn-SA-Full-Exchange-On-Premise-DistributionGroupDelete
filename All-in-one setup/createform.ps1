...
<# Begin: DataSource "Exchange-distributiongroup-delete-generate-table-wildcard" #>
$tmpPsScript = @'
try {
...
'@ 
$tmpModel = @'
[{"key":"DisplayName","type":0},{"key":"UserPrincipalName","type":0},{"key":"DN","type":0}]
'@ 
$tmpInput = @'
...
Exchange-distributiongroup-delete-generate-table-wildcard
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_0_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_0) 
<# End: DataSource "Exchange-distributiongroup-delete-generate-table-wildcard" #>
<# End: HelloID Data sources #>

<# Begin: Dynamic Form "Exchange on-premise - Delete distribution list" #>
$tmpSchema = @"
[{"key":"searchfield","templateOptions":{"label":"Search","required":true},"type":"input","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":false},{"key":"gridGroups","templateOptions":{"label":"Select group","required":true,"grid":{"columns":[{"headerName":"Display Name","field":"DisplayName"},{"headerName":"User Principal Name","field":"UserPrincipalName"},{"headerName":"DN","field":"DN"}],"height":300,"rowSelection":"multiple"},"dataSourceConfig":{"dataSourceGuid":"$dataSourceGuid_0","input":{"propertyInputs":[{"propertyName":"searchValue","otherFieldValue":{"otherFieldKey":"searchfield"}}]}},"useFilter":true,"useDefault":false},"type":"multiselectgrid","summaryVisibility":"Show","requiresTemplateOptions":true,"requiresKey":true,"requiresDataSource":true}]
"@ 

$dynamicFormGuid = [PSCustomObject]@{} 
$dynamicFormName = @'
Exchange on-premise - Delete distribution list
'@ 
